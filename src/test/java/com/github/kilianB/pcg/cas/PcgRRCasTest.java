...
class PcgRRCasTest {
	...
	class State {
		...
		void equalGenerationSeed() {
			Pcg rng0 = new PcgRRCas(0, 0);
			Pcg rng1 = new PcgRRCas(0, 0);
		...
		void unequelGenerationSeed() {
			...
			Pcg rng0 = new PcgRRCas();
			Pcg rng1 = new PcgRRCas();
	...
	class Distance {
		...
		void reSeed() {
			...
			// Seed both instances
			rng = new PcgRRCas(seed, streamNumber);
			rng0 = new PcgRRCas(seed, streamNumber);
		}
