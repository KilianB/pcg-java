...
class PcgRSCasTest {
	...
	class State {
		...
		void equalGenerationSeed() {
			Pcg rng0 = new PcgRSCas(0, 0);
			Pcg rng1 = new PcgRSCas(0, 0);
		...
		void unequelGenerationSeed() {
			...
			Pcg rng0 = new PcgRSCas();
			Pcg rng1 = new PcgRSCas();
	...
	class Distance {
		...
		void reSeed() {
			...
			// Seed both instances
			rng = new PcgRSCas(seed, streamNumber);
			rng0 = new PcgRSCas(seed, streamNumber);
		}
