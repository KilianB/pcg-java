 ...
 *
 */
class PcgRSLockedTest {

	@Nested
	class State {
		
		void equalGenerationSeed() {
			Pcg rng0 = new PcgRSLocked(0, 0);
			Pcg rng1 = new PcgRSLocked(0, 0);
		...
		void unequelGenerationSeed() {
			...
			Pcg rng0 = new PcgRSLocked();
			Pcg rng1 = new PcgRSLocked();
	...
	class Distance {
		...
		void reSeed() {
			...
			// Seed both instances
			rng = new PcgRSLocked(seed, streamNumber);
			rng0 = new PcgRSLocked(seed, streamNumber);
		}
